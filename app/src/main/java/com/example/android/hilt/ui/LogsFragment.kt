...
import com.example.android.hilt.di.database.InMemoryLogger
...
class LogsFragment : Fragment() {
    ...
    @InMemoryLogger
    @Inject lateinit var logger: LoggerDataSource //field logger injection
    //in Dagger, we were required to pass instance of LogsFragment into Dagger Framework, so that
    //Dagger Framework then can utilize LogsFragment's instance to full logger value.

    //It means, field injection means getting required dependency from dagger framework with the
    //help of the class where the filed is defined
